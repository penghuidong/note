...
static const char qt_meta_stringdata_CalculatorUI[] = {
    "CalculatorUI\0\0onButtonClicked()\0"
};
...
void CalculatorUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        CalculatorUI *_t = static_cast<CalculatorUI *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData CalculatorUI::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CalculatorUI::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CalculatorUI,
      qt_meta_data_CalculatorUI, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CalculatorUI::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalculatorUI))
        return static_cast<void*>(const_cast< CalculatorUI*>(this));
